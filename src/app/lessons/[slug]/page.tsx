  ...
  if (!lesson) {
    return (
      <div className="py-20 text-center space-y-4 font-mono">
        <h2 className="text-2xl text-rose-400">Lesson Not Found</h2>
        <p className="text-xs text-slate-400">The requested kernel guide does not exist in the database.</p>
        <Link href="/lessons" className="text-xs text-os-cyan underline">
          &lt; Return to Lessons Catalog
        </Link>
      </div>
    );
  }
